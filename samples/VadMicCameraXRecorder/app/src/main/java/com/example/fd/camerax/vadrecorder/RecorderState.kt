...
import com.example.fd.camerax.vadrecorder.camerax.ThinkletRecorder
import com.example.fd.camerax.vadrecorder.camerax.vadMic
        ...
        lifecycleOwner.lifecycleScope.launch {
            recorderMutex.withLock {
                ...
                recorder = ThinkletRecorder.create(
                    ...
                    mic = ThinkletMics.vadMic(context, lifecycleOwner),
